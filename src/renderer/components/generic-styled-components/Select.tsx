...
export const SelectWrap = styled.div`
  ...
  align-items: center;
  padding-left: ${(props: ISelectProps): string =>
    props.paddingLeft ? props.paddingLeft : '0px'};
  padding-top: ${(props: ISelectProps): string =>
    props.paddingTop ? props.paddingTop : '0px'};
  padding-right: ${(props: ISelectProps): string =>
    props.paddingRight ? props.paddingRight : '0px'};
  padding-bottom: ${(props: ISelectProps): string =>
    props.paddingBottom ? props.paddingBottom : '0px'};
  width: ${(props: ISelectProps): string =>
...
export const botSelectStyles = {
  ...
  option: (provided: any, state: any) => ({
    ...
    backgroundColor: state.isSelected
      ? `${dropDownBoxSelectedColor} !important`
      : dropDownBoxBackgroundColor
  })
};
